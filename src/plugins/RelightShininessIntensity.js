...
/**
 * The RelightShininessIntensity component is a component that is used to render a slider component to change
 * the shininess of the Three canvas scene.
 */
class RelightShininessIntensity extends React.Component {
  constructor(props) {
    super(props);
  }
...
RelightShininessIntensity.propTypes = {
...
export default RelightShininessIntensity;
