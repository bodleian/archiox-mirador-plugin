...
/**
 * The RelightAmbientLightIntensity component is a component that is used to render a slider component to change the
 * ambient light intensity of the Three canvas scene.
 */
