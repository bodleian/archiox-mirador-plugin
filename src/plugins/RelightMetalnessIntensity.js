...
/**
 * The RelightMetalnessIntensity component is a component that is used to render a slider component to change the
 * metalness intensity of the Three canvas scene PBR shader/MeshStandardMaterial.
 */
class RelightMetalnessIntensity extends React.Component {
  constructor(props) {
    super(props);
  }
...
RelightMetalnessIntensity.propTypes = {
...
export default RelightMetalnessIntensity;
